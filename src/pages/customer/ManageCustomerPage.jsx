...
export default function ManageCustomerPage() {
  ...
  const openUpdateModal = (customer) => {
    setEditData({
      ...customer,
      customerContactNumber: customer.customerContactNumber?.toString() || "",
    });
  ...
  const submitUpdate = async () => {
    ...
    try {
      ...
      const response = await api.put(`/customers/${editData._id}`, payload);
  ...
  const confirmDelete = async () => {
    try {
      await toast.promise(api.delete(`/customers/${deleteId}`), {
        loading: "Deleting customer...",
        success: "Customer deleted successfully!",
        error: "Delete failed!",
      });

      const updated = customers.filter((customer) => customer._id !== deleteId);
